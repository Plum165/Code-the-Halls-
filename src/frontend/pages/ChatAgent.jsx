  ...
  const handleSupportResponse = (response) => {
    if (response === 'yes') {
      ...
      setTimeout(() => {
        setMessages(prev => [...prev, { 
          sender: "professional", 
          text: "Thank you for reaching out. My name is John, and I am a qualified psychologist. I'm here to listen and support you. It takes courage to ask for help, and I appreciate you taking this step. Please be aware that this chat will be recorded for quality and safety purposes. Whenever you're ready, would you like to share what’s on your mind?"
        }]);
      }, 500);
    } else {
      setShowSupportDialog(false);
