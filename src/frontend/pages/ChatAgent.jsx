  ...
  const professionalScript = [
    {
      id: 0,
      sender: "professional",
      text: "Hello, my name is Dr. Nadine Snyman. I’m a counsellor who specialises in supporting survivors of gender-based violence. Thank you for reaching out, that takes courage. This is a safe and confidential space. How can I support you today?",
      // text: "Hi, I’m here with you. You’ve reached professional support. Are you safe right now?",
    },
    {
      id: 1,
      sender: "professional",
    ...
    },
    {
      id: 2,
      sender: "professional",
      text: "Thank you for letting me know. We can take this at your pace. Would you like to talk about what has been happening, or would you like to explore support options?",
      decision: true, // requires branching
    },
    {
      id: "options_yes",
      sender: "professional",
      text: "Here are a few options: we can stay here and talk, connect you to a hotline, or help contact emergency services.",
    },
    {
      id: "options_no",
      sender: "professional",
      text: "That’s completely okay. We can just take things one step at a time. I’m here with you.",
    },
    {
      id: 3,
      sender: "professional",
      text: "I’m really sorry that you’re going through this. What you’re experiencing is not your fault. How long has this been going on?",
    },
    {
      id: 4,
      sender: "professional",
      text: "Thats still a long time.",
    },
  ];
  ...
  const sendMessage = async (text) => {
    ...
    if (isInProfessionalMode) {
      ...
      if (currentScript?.decision) {
        ...
        if (isYes(text)) {
          nextMessage = professionalScript.find(
            (step) => step.id === "options_yes"
          );
        } else if (isNo(text)) {
          nextMessage = professionalScript.find(
            (step) => step.id === "options_no"
          );
        } else {
          nextMessage = {
            text: "That’s okay — just let me know yes or no when you’re ready.",
          };
        }

        setMessages((prev) => [
          ...prev,
          { sender: "professional", text: nextMessage.text },
        ]);
    ...
    try {
      const response = await fetch("http://localhost:5000/api/chat", {
        ...
        body: JSON.stringify({
          message: text,
          professionalMode: isInProfessionalMode,
        }),
      });
            ...
            chats.map((chat) => (
              <div
                ...
                className={`chat-item ${
                  ...
                  currentChatId === chat.id && isInProfessionalMode
                    ? "professional-chat"
                    : ""
                }`}
      ...
      <div className="chat-main">
        <div className="chat-header">
          <div className="chat-header-left">
            <h3>
              Chat Agent {isInProfessionalMode && "👨‍⚕️ Professional Support"}
            </h3>
          ...
          {showSupportDialog && (
            <div className="support-dialog">
              ...
              <p>
                ...
                like to talk to a professional who can provide support?
              </p>
              <p>
                This will switch you to a confidential support mode where you
                can speak freely about your concerns.
              </p>
