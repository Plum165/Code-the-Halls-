...
export default function ChatAgent() {
  ...
  const professionalScript = [
    ...
    },
    {
      id: "emotional_ack",
      sender: "professional",
      text: "It sounds like you're trying to express something painful or difficult to talk about. That's completely okay — you don't have to explain it perfectly. I'm here with you.",
    },
    // SUPPORT DIRECTION
    {
      id: "support_choice",
