...
//               <span className="export-icon"></span>  📄 Export chat
//           </button>
...
//               <span style={{ fontSize: '12px', color: '#70db99af', marginLeft: 'auto' }}>
//               chat with Dr Bob
//               </span>
//             )}
//           </div>
...
//                 <h3>VEA{isInProfessionalMode && "👤 Dr Bob"}</h3>
...
//               <p>I noticed you might be going through a difficult time. Would you like to connect with a professional who can provide support?</p>
//               <p>This will switch you to a confidential support mode where you can speak freely about your concerns and gain trusted professional supportt.</p>
...
export default function ChatAgent() {
  ...
  // 🌟 UPDATED: Professional mode acceptance
  const handleSupportResponse = (response) => {
    if (response === "yes") {
      setIsInProfessionalMode(true);
      setShowSupportDialog(false);
      ...
      setMessages((prev) => [
        ...
        {
          sender: "system",
          text: `------------------- You are now chatting with Dr. Bob ${now} ---------------------`
        }
      ]);
      ...
      setTimeout(() => {
        setMessages((prev) => [
          ...prev,
          {
            sender: "professional",
            text:
              "Thank you for reaching out. I'm here to listen and support you. Would you like to talk about what's bothering you?"
          }
        ]);
      }, 500);
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          sender: "bot",
          text:
            "That's okay. I'm here if you change your mind. Is there anything else I can help with?"
        }
      ]);
    }, 500);
  };
      ...
      <div className="chat-sidebar">
        ...
        <div className="chat-list">
          {chats.map((chat) => (
            ...
            <button className="export-btn" onClick={exportChatAsPDF}>📄 Export chat</button>
